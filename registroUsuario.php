     ...
     <div class="container">
          <div id="borde">
             <form action="confirmarDatos.php" method="POST">
               <input type="text" name="PrimerNombre"  class="form-control " onkeypress="return SoloLetras(event);" placeholder="Primer Nombre"  maxlength="20" minlength="3" required="true">
              <br>
              <input type="text" name="SegundoNombre"  class="form-control " onkeypress="return SoloLetrasYcaracteres(event);" placeholder="Segundo Nombre" maxlength="20" >
              <br>
               <input type="text" name="PrimerApellido"  class="form-control " onkeypress="return SoloLetrasYcaracteres(event);" placeholder="Primer Apellido" maxlength="20" minlength="3" required="true">
              <br>
              <input type="text" name="SegundoApellido"  class="form-control " onkeypress="return SoloLetrasYcaracteres(event);" placeholder="Segundo Apellido" maxlength="50" minlength="3" required="true">
              <br>
